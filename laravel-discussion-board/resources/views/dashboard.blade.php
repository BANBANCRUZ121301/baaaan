        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white shadow-lg rounded-lg p-4">
                    ...
                    <a href="{{ route('posts.index') }}" class="mt-4 inline-block bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Manage Posts</a>
                </div>
                ...
                <div class="bg-white shadow-lg rounded-lg p-4">
                    ...
                    <a href="{{ route('posts.create') }}" class="mt-4 inline-block bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600">Create Post</a>
                </div>
                ...
                <div class="bg-white shadow-lg rounded-lg p-4">
                    ...
                    <a href="{{ route('profile.edit') }}" class="mt-4 inline-block bg-yellow-500 text-white py-2 px-4 rounded hover:bg-yellow-600">Edit Profile</a>
                </div>
            </div>
        </div>
    </div>
